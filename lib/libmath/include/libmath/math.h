...
struct Vec2 {
  ...
  inline float cross(const Vec2 &v) { return x * v.y - y * v.x; }
  inline float cross(const float s) { return x * s - y * s; }
};
...
inline Vec2 operator+(const Vec2 &v, const float s) { return v + Vec2::CTE(s); }
inline Vec2 operator-(const Vec2 &v, const float s) { return v - Vec2::CTE(s); }
inline Vec2 operator*(const Vec2 &v, const float s) { return v * Vec2::CTE(s); }
inline Vec2 operator/(const Vec2 &v, const float s) { return v / Vec2::CTE(s); }
...
inline bool operator<(const Vec2 &v, const float s) { return v < Vec2::CTE(s); }
inline bool operator<=(const Vec2 &v, const float s) {
  return v <= Vec2::CTE(s);
}
inline bool operator>(const Vec2 &v, const float s) { return v > Vec2::CTE(s); }
...
inline Vec2 operator+(const float s, const Vec2 &v) { return Vec2::CTE(s) + v; }
inline Vec2 operator-(const float s, const Vec2 &v) { return Vec2::CTE(s) - v; }
inline Vec2 operator*(const float s, const Vec2 &v) { return Vec2::CTE(s) * v; }
inline Vec2 operator/(const float s, const Vec2 &v) { return Vec2::CTE(s) / v; }
...
inline bool operator<(const float s, const Vec2 &v) { return Vec2::CTE(s) < v; }
inline bool operator<=(const float s, const Vec2 &v) {
  return Vec2::CTE(s) <= v;
}
inline bool operator>(const float s, const Vec2 &v) { return Vec2::CTE(s) > v; }
